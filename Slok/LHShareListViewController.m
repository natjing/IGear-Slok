...
@interface LHShareListViewController ()<UITableViewDataSource,UITableViewDelegate,DFUServiceDelegate,DFUProgressDelegate,CBCentralManagerDelegate,CBPeripheralDelegate,CBPeripheralManagerDelegate>
